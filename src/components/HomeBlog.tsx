...
const HomeBlog = () => {
  ...
  return (
    <div className='bg-[#f3f1f6] md:pt-10 lg:px-24 md:px-10 sm:px-12 px-10 md:pb-10 pb-5 text-gray-900 overflow-x-hidden'>
        <h2 className='font-bold md:text-5xl tracking-wider leading-snug text-4xl text-center mb-8 sm:mb-12'>Explore the Highlighted Blog</h2>
        <div className='flex md:flex-row flex-col justify-around gap-6 items-center'>
            ...
            <div className="content">
                <h3 className='font-semibold min-[380px]:text-2xl text-xl tracking-wider text-center my-2 sm:my-3' >Does your heart ever scream, &apos;Pack your bags and let&apos;s go!&apos;?</h3>
                <p className='tracking-wide min-[380px]:text-lg  leading-snug'>If you&apos;ve ever caught yourself daydreaming about far-off places—where mountains kiss the sky, oceans shimmer in the sunlight, and cultures intertwine in the most beautiful ways—then you&apos;re not alone.<span className='min-[380px]:block hidden'>Travel isn&apos;t just about visiting new places; it&apos;s about discovering a new side of yourself with every step you take.</span></p>
