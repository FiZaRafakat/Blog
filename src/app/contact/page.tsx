...
const Page = () => {
  ...
  return (
    <div className='bg-[#f3f1f6] text-gray-900'>
        <Header />
        <div className='md:w-[600px] sm:w-[500px] min-[500px]:w-[450px] min-[400px]:w-[380px] min-[300px]:w-[280px] w-[200px] mx-auto pb-16 pt-10 '>
          <div className='lg:mx-12 md:mx-5 mb-5'>
          <h2 className='font-medium text-lg text-center'>At <span className='font-bold italic text-xl'>DizzyBlog</span> , we love to connect, inspire, and grow together. Reach out to share your thoughts, ideas, or just to say hi – because every great story starts with a conversation ! </h2>
          </div>
         {/* Form Div */}
         <form action="" method='POST' className=" md:space-y-1 flex flex-col shadow-[#113946] shadow-md lg:px-8 lg:mx-12 md:mx-5 sm:px-8 px-3 rounded-xl md:pb-10 md:pt-10 pt-5 pb-2 gap-2">
         ...
         {/* <label htmlFor="Subject" className="flex flex-col gap-2">
          <p className="text-[16px] font-medium">Subject</p>
            <input type="text" name="Subject" id="Subject" placeholder="This is an optional" className="focus:border focus:border-[#113946] border-gray-100 border bg-gray-200 placeholder:text-gray-600 min-[400px]:text-base text-sm w-full min-[400px]:px-4 px-2 py-2 min-[400px]:rounded-xl rounded-md outline-none " />
          </label> */}
